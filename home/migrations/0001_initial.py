        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "client_reviews",
                    models.TextField(
                        help_text="use | for next line . Only 6 lines allowed"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        help_text="use | for next line . Only 4 lines allowed"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "counts_title",
                    models.TextField(
                        help_text="use | for next line..only 4 line is allowed"
                    ),
                ),
                ("counts_number", models.IntegerField(help_text="use | for next line")),
            ],
        ),
        migrations.CreateModel(
            name="HomePage",
            fields=[
                ...
                (
                    "about_us",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="home.aboutus"
                    ),
                ),
                ...
                (
                    "cover",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="home.cover"
                    ),
                ),
                (
                    "testimonial",
                ...
                (
                    "why_choose",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="home.whychoose"
                    ),
                ),
                (
                    "work_history",
